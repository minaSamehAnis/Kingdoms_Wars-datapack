...
# 2. Give the item if missing (Formatted for 1.21.1)
execute if score #has_item temp matches 0 run give @s minecraft:carrot_on_a_stick[custom_model_data=1,custom_data={shop_menu:1b},hide_additional_tooltip={},item_name='{"text":"🏪 Shop Menu","color":"gold","bold":true,"italic":false}',lore=['{"text":"Right click to open shop","color":"gray","italic":false}','{"text":""}','{"text":"💰 Buy & Sell Items","color":"yellow","italic":false}','{"text":""}','{"text":"Lost this item? Just type:","color":"dark_gray","italic":false}','{"text":"/shop","color":"green","italic":false}']] 1

# 3. Success messages and sounds
...
# 4. If player already has the item
